import {createDeployment, getPendingDeployments, createDeploymentStatus} from '..';

jest.mock('@octokit/rest', () => class Octokit {
  ...
  get repos() {
    return {
      ...
      listDeploymentStatuses: () => Promise.resolve({data: [{state: 'success', updated_at: '2019-11-07T06:06:31Z'}]}),
    };
  }
});
